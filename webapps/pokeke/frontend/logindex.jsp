			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">
						<li><a class="scroll-link"  onclick="window.open('../asset2.0/logout.jsp','_self')">玩家登出</a></li>
						<li><a class="scroll-link" onclick="window.open('../asset2.0/testlogin.jsp','_self')">我要註冊</a></li>
    ...
    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
        ...
        <div class="row">
          <br>
            <br>
            <div >
              <button id = "word" style="cursor:pointer;background-color:	#00BBFF;width:250px;height:50px;font-size:10px;color:rgba(30%,30%,40%,0.05);">
                <div style="color: black;font-size: 20px;">我想對你說</div>
              </div>
